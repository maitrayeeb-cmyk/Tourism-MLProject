...
PreferredPropertyStar=st.selectbox("Preferred Property Star:Preferred hotel rating by the customer.", ["3 Stars", "4 Stars", "5 Stars"])
...
Passport=st.selectbox("Passport:Whether the customer holds a valid passport (0: No, 1: Yes).", ["No", "Yes"])
